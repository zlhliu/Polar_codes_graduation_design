    ...
    for (size_t i = 0; i < 1024; i++){
        ...
        if (channel[i]==0){ // 此bit的信道为冷冻信道
            ...
            if(state==0){ // 如果是全0,则判断是否可以形成更大的节点
                ...
                node_state[10][end].state=R1; // 只能是全1节点
                ...
                node_state[10][end].state=SPC; // 记录为0111……节点
                node_state[10][end].num=end-pre+1;
                i=end;
                pre=i+1,end=pre;
                num=0;
