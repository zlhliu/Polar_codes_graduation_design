...
int main() {
    ...
    int info_bits=512; // 512 inf bits  
    int total_bits=1024; // 1024 total bits
    ...
    for(int times=0;times<num_snr;times++){
        ...
        encoder my_encoder(std::move(message),info_bits,total_bits,Q); // coding message
        ...
        decoder my_decoder(std::move(my_demodulation.result()),"sc",Q);
